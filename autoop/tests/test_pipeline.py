...
class TestPipeline(unittest.TestCase):
    ...
    def test_evaluate(self):
        ...
        self.pipeline._split_data()
        self.pipeline._train()
        self.pipeline._evaluate(self.pipeline._train_X, self.pipeline._train_y, data_type="training")
        self.assertIsNotNone(self.pipeline._metrics_results_train)
        self.assertIsNotNone(self.pipeline._prediction_train)
        self.pipeline._evaluate(self.pipeline._test_X, self.pipeline._test_y, data_type="evaluation")
        self.assertIsNotNone(self.pipeline._metrics_results_train)
