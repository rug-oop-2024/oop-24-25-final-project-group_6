...
class TestStorage(unittest.TestCase):
    """
    Class that is used for testing the LocalStorage class.
    """
    def setUp(self) -> None:
        """
        Method that is ran before the tests begin.

        A temporary dictonary and a storage is created for testing purposes.
        """
    ...
    def test_init(self) -> None:
        """
        Tests the initalizer method of the LocalStorage class
        """
        self.assertIsInstance(self.storage, LocalStorage)

    def test_store(self) -> None:
        """
        Tests the store method of the LocalStorage class.
        """
    ...
    def test_delete(self) -> None:
        """
        Tests the delete method of the LocalStorage class.
        """
        key = str(random.randint(0, 100))
        test_bytes = bytes([random.randint(0, 255) for _ in range(100)])
        key = f"test{os.sep}path"
    ...
    def test_list(self) -> None:
        """
        Tests the list method of the LocalStorage class.
        """
        key = str(random.randint(0, 100))
        test_bytes = bytes([random.randint(0, 255) for _ in range(100)])
